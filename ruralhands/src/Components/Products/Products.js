        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Discover unique, authentic products made by talented artisans
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product) => (
              <div 
                key={product.id} 
                className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 relative border border-orange-100 cursor-pointer"
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button
                      ...
                      className="p-2 bg-white rounded-full shadow-md hover:bg-orange-50 transition-colors border border-orange-100"
                    >
                      <Heart
                        className={`w-4 h-4 ${
                          favorites.has(product.id)
                  ...
                  {!product.outOfStock && (
                    <div className="absolute bottom-3 left-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <button 
                        ...
                        className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-2 px-4 rounded-md flex items-center justify-center gap-2 hover:from-orange-600 hover:to-red-600 transition-all duration-200 shadow-lg"
                      >
