import { CheckCircle, CreditCard, Lock, Mail, MapPin, Phone, Shield, Smartphone, User, Zap } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md mx-4 text-center shadow-2xl">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-4">
              <p className="text-green-800 font-medium">Order Total: Rs 13,350</p>
              <p className="text-green-600 text-sm">Transaction ID: #RH2025001234</p>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              {paymentMethod === 'wallet' && (
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-gray-500 text-center mt-4">
                    Select your preferred digital wallet to complete payment securely
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                <div className="bg-green-50 border border-green-200 rounded-xl p-4">
                  ...
                  <p className="text-green-700 text-sm">Your data is protected</p>
                </div>

                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <div className="flex items-center mb-2">
                    <CheckCircle className="text-blue-600 mr-2" size={20} />
                    <span className="font-semibold text-blue-800">PCI DSS Compliant</span>
                  </div>
                  <p className="text-blue-700 text-sm">Industry standard security</p>
                </div>

                <div className="bg-purple-50 border border-purple-200 rounded-xl p-4">
                  <div className="flex items-center mb-2">
                    <Zap className="text-purple-600 mr-2" size={20} />
                    <span className="font-semibold text-purple-800">Instant Processing</span>
                  </div>
                  <p className="text-purple-700 text-sm">Real-time payment verification</p>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                <div className="flex items-center space-x-2 flex-wrap gap-2">
                  ...
                  <div className="bg-red-600 text-white px-3 py-1 rounded text-xs font-bold">MASTER</div>
                  <div className="bg-green-600 text-white px-3 py-1 rounded text-xs font-bold">BOC</div>
                  <div className="bg-purple-600 text-white px-3 py-1 rounded text-xs font-bold">PEOPLES</div>
                  <div className="bg-orange-600 text-white px-3 py-1 rounded text-xs font-bold">HNB</div>
                  <div className="bg-blue-500 text-white px-3 py-1 rounded text-xs font-bold">SAMPATH</div>
                  <div className="bg-red-500 text-white px-3 py-1 rounded text-xs font-bold">COMBANK</div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between text-lg font-bold">
                  <span>Total</span>
                  <span className="text-orange-600">Rs 13,350</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-green-500 to-green-600 text-white font-bold py-4 px-6 rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center text-lg"
            >
