  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mt-6 w-32 h-1 bg-gradient-to-r from-orange-500 to-red-500 mx-auto rounded-full"></div>
          ...
          <div className="bg-gradient-to-r from-orange-600 to-red-600 text-white p-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-orange-100">Online and ready to help</p>
              </div>
              ...
              >
                <div className={`flex max-w-xs lg:max-w-md ${message.isBot ? 'flex-row' : 'flex-row-reverse'}`}>
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    message.isBot ? 'bg-orange-500 mr-2' : 'bg-red-500 ml-2'
                  }`}>
                    {message.isBot ? (
            ...
            {isTyping && (
              <div className="flex justify-start mb-4">
                <div className="flex flex-row">
                  <div className="w-8 h-8 rounded-full bg-orange-500 mr-2 flex items-center justify-center">
                    <Bot className="w-5 h-5 text-white" />
                  </div>
          ...
          <div className="p-4 border-t border-gray-200 bg-white">
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="bg-orange-600 text-white px-4 py-2 rounded-lg hover:bg-orange-700 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center transition-colors"
              >
