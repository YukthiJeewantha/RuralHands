import { Clock, Facebook, Globe, Instagram, Mail, MapPin, MessageCircle, Palette, Phone, Star, Twitter } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-orange-100">
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-4 px-8 rounded-xl hover:from-orange-600 hover:to-red-600 transition transform hover:scale-105 shadow-lg flex items-center justify-center text-lg"
              >
